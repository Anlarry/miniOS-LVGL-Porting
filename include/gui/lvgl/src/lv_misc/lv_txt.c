...
void InitTxt() {
#if LV_TXT_ENC == LV_TXT_ENC_UTF8
    _lv_txt_encoded_size        = lv_txt_utf8_size;
    _lv_txt_unicode_to_encoded   = lv_txt_unicode_to_utf8;
    _lv_txt_encoded_conv_wc      = lv_txt_utf8_conv_wc;
    _lv_txt_encoded_next         = lv_txt_utf8_next;
    _lv_txt_encoded_prev         = lv_txt_utf8_prev;
    _lv_txt_encoded_get_byte_id  = lv_txt_utf8_get_byte_id;
    _lv_txt_encoded_get_char_id  = lv_txt_utf8_get_char_id;
    _lv_txt_get_encoded_length   = lv_txt_utf8_get_length;
#elif LV_TXT_ENC == LV_TXT_ENC_ASCII
    _lv_txt_encoded_size          = lv_txt_iso8859_1_size;
    _lv_txt_unicode_to_encoded   = lv_txt_unicode_to_iso8859_1;
    _lv_txt_encoded_conv_wc      = lv_txt_iso8859_1_conv_wc;
    _lv_txt_encoded_next         = lv_txt_iso8859_1_next;
    _lv_txt_encoded_prev         = lv_txt_iso8859_1_prev;
    _lv_txt_encoded_get_byte_id  = lv_txt_iso8859_1_get_byte_id;
    _lv_txt_encoded_get_char_id  = lv_txt_iso8859_1_get_char_id;
    _lv_txt_get_encoded_length   = lv_txt_iso8859_1_get_length;
