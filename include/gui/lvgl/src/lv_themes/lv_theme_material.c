 ...
 *  STATIC VARIABLES
 **********************/
static lv_theme_t theme __attribute__((section(".data")));
static theme_styles_t * styles __attribute__((section(".data")));

static bool inited __attribute__((section(".data")));
