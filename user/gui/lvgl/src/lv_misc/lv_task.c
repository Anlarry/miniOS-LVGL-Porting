 ...
 *  STATIC VARIABLES
 **********************/
static bool lv_task_run __attribute__((section(".data"))) = false;
static uint8_t idle_last __attribute__((section(".data"))) = 0;
static bool task_deleted __attribute__((section(".data")));
static bool task_list_changed __attribute__((section(".data")));
static bool task_created __attribute__((section(".data")));
...
LV_ATTRIBUTE_TASK_HANDLER uint32_t lv_task_handler(void)
{
    ...
    static bool already_running __attribute__((section(".data"))) = false;
    if(already_running) return 1;
    already_running = true;

    static uint32_t idle_period_start __attribute__((section(".data"))) = 0;
    static uint32_t handler_start    __attribute__((section(".data"))) = 0;
    static uint32_t busy_time      __attribute__((section(".data"))) = 0;
    static uint32_t time_till_next __attribute__((section(".data")));
